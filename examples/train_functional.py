...
from DLWP.custom import PeriodicPadding2D, RNNResetStates, EarlyStoppingMin, latitude_weighted_loss
...
# Data parameters. Specify the input/output variables/levels and input/output time steps. DLWPFunctional requires the
# Ensure that the selections use LISTS of values (even for only 1) to keep dimensions correct. The number of output
# forecast steps to train on is given by integration_steps. The actual number of forecast steps is io_time_steps *
# integration_steps.
